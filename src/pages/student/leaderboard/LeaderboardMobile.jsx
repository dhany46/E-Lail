...
const LeaderboardMobile = () => {
    ...
    return (
        <div className="h-screen overflow-y-auto scrollbar-hide scroll-smooth overscroll-none bg-[#EEF7FF] font-sans relative pb-44">
            ...
            {/* Sticky Footer */}
            <div className="fixed bottom-28 left-0 right-0 px-4 z-50 animate-fade-in-up opacity-0 flex justify-center" style={{ animationDelay: '0.5s', animationFillMode: 'forwards', animationDuration: '0.6s' }}>
